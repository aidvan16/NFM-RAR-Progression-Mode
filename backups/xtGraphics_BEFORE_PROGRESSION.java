...
implements Runnable {
    ...
    public void hipnoload(int n, boolean bl) {
        ...
        if (n5 == 0) {
            ...
            if (n == 35) {
                this.rd.drawString("Imagine a vehicle with the strength of EL King and Speed of Radical One.", 197, 67);
                this.rd.drawString("You are about to meet Dr. Monstaa in this course.", 197, 87);
                this.rd.drawString("Always keep an eye out to make sure he isn't chasing you.", 197, 107);
                this.rd.drawString("One nasty hit from him could end your run!", 197, 107);
            }
            if (n == 36) {
            ...
            if (n == 37) {
                ...
                this.rd.drawString("Hint 2: It might sound crazy, but pick a slower vehicle.", 197, 87);
            }
            if (n == 38) {
            ...
            if (n == 41) {
                this.rd.drawString("Its everyone vs you! Lets see if you have what it takes to win the gauntlet!", 197, 67);
            }
            if (n == 42) {
                ...
                this.rd.drawString("Like Moonlight, this stage is very crammed, so finish quick and dont get lost!", 197, 107);
            } if (n == 43) {
                this.rd.drawString("Its a Derby on the dance floor!", 197, 67);
                this.rd.drawString("There is a new tank on the field, but this one is more powerful!", 197, 67);
            }
            ...
            if (n == 45) {
                this.rd.drawString("Yes, you have to complete ten laps. Yes, the course is massive.", 197, 67);
