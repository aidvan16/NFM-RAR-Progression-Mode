...
implements Runnable {
    ...
    29,  // 49-50 ROCKET M A S H E E N
    30,  // 51-52 Dr Rocket Monstaa
    31,  // 53-54 The Awesome Radical One
    32,  // 55-56 Over=Kill
    33,  // 57-58 The Phantom
    39,  //TN
    34,  //LR
    35,  // K
    37,  // ToT
    ...
    public void inst(Control control) {
        ...
        if (this.flipo == 15) {
            this.rd.drawString("There are a total of 70 stages!", 197, 42);
            this.rd.drawString("All cars and stages progressively unlock as you", 197, 62);
            this.rd.drawString("beat more stages in this mod!", 197, 82);
    ...
    public void loadmusic(int n, int n2) {
        ...
        if (n == 45) {
            this.stracks[44].loadMod(250, 8000, 145, this.sunny, this.macn);
        }
        if (n == 46) {
            this.stracks[45].loadMod(250, 8100, 125, this.sunny, this.macn);
        }
        if (n == 47) {
    ...
    public void credits(Control control) {
        ...
        if (this.flipo == 101) {
            ...
            this.drawcs(155, "Mod Created by Aidvan16, but all credit goes to Ryan and Omar!", 0, 0, 0, 3);
            this.rd.setFont(new Font("SansSerif", 1, 13));
            this.ftm = this.rd.getFontMetrics();
        ...
        if (this.flipo == 103) {
            ...
            this.drawcs(100, "40 Cars and 70 Stages!", 0, 0, 0, 3);
            this.drawcs(120, "Includes all original stages and cars", 0, 0, 0, 3);
            this.drawcs(140, "Many new stages from Old and New NFM RAR games.", 0, 0, 0, 3);
            this.drawcs(160, "More powerful late-game cars (Destroyer, Warhead, etc.)", 0, 0, 0, 3);
            this.drawcs(180, "Power BEYOND the MAX", 0, 0, 0, 3);
            this.drawcs(200, "Fight your own kind", 0, 0, 0, 3);
            this.drawcs(220, "More challenging and varied gameplay", 0, 0, 0, 3);
            this.drawcs(240, "FLOATING STAGES!", 0, 0, 0, 3);
            this.drawcs(260, "Stage-specific AI and boss encounters", 0, 0, 0, 3);
            this.drawcs(280, "More Challenging Gameplay", 0, 0, 0, 3);
            this.drawcs(300, "Progressive unlocks! Starting at 5 cars, going up to 40!", 0, 0, 0, 3);
            this.drawcs(320, "More variety throughout the campaign", 0, 0, 0, 3);
            this.drawcs(340, "The biggest NFM2 RAR extension yet", 0, 0, 0, 3);
            this.drawcs(360, "Thank you very much for playing my mod!", 0, 0, 0, 3);
        ...
        if (this.winner) {
            ...
            if (checkPoints.stage == this.unlocked) {
                ...
                if (checkPoints.stage != 70) {
                    ...
                    if (this.aflk) {
                        this.drawcs(140, "CONGRATULATIONS", 0, 0, 0, 3);
                    } else {
                        this.drawcs(142, "CONGRATULATIONS", 255, 255, 255, 3);
                    }
                    if (this.aflk) {
                        this.drawcs(190, "THANK YOU FOR PLAYING MY MOD!", 0, 255, 0, 3);
                    } else {
                        this.drawcs(190, "THANK YOU FOR PLAYING MY MOD!", 0, 100, 0, 3);
                    }
                    this.rd.setColor(new Color(0, 0, 0));
                    ...
                    if (this.radpx == 147) {
                        ...
                        this.ftm = this.rd.getFontMetrics();
                        if (this.aflk) {
                            this.drawcs(259, "Made by Aidvan! (Original by NFME)", 0, 0, 0, 3);
                        } else {
                            this.drawcs(259, "Made by Aidvan! (Original by NFME)", 255, 0, 0, 3);
                        }
                    }
                    if (this.aflk) {
                        this.drawcs(300, "Now try the challenges!", 255, 255, 255, 3);
                    } else {
                        this.drawcs(300, "Now try the challenges!", 0, 0, 0, 3);
                    }
                    this.pin = 0;
                }
                this.aflk = !this.aflk;
    ...
    public void stageselect(CheckPoints checkPoints, Control control) {
        ...
        this.ftm = this.rd.getFontMetrics();
        if (checkPoints.stage == 57 || checkPoints.stage == 58 || (checkPoints.stage >= 61 && checkPoints.stage <= 70)) {
            this.rd.setColor(new Color(0, 255, 0));
            this.rd.drawString("RACE-ONLY STAGE!", 224, 376);
        }
        if (checkPoints.stage == 9 || checkPoints.stage == 41 || checkPoints.stage == 43) {
            this.rd.setColor(new Color(255, 0, 0));
    ...
    public void carselect(Control control, ContO[] contOArray, Madness madness) {
        ...
        if (this.flipo == 0) {
            ...
            if (this.getCarOrderIndex(this.sc[0]) >= this.carsUnlocked || (this.sc[0] == 33 && this.carsUnlocked < 40)) {
                int n2;
                if (this.gatey == 300) {
                    n2 = 0;
                    do {
                ...
                if (this.flatrstart == 6) {
                    ...
                    if (this.sc[0] == 33) {
                        this.drawcs(355, "Complete HELL to unlock The Phantom...", 181, 120, 40, 3);
                    } else {
        ...
        if (control.handb || control.enter) {
            ...
            if (this.flipo == 0 && carPos >= 0 && carPos < this.carsUnlocked && (this.sc[0] != 33 || this.carsUnlocked >= 40)) {
                this.lastload = -11;
                this.cars.stop();
                this.cars.unloadMod();
                this.m.crs = false;
    ...
    public void hipnoload(int n, boolean bl) {
        ...
        if (n5 == 0) {
            ...
            if (n == 45) {
                this.rd.drawString("Welcome to the Death Pit. TURBO TANK is here, and he's incredibly dangerous.", 197, 67);
                this.rd.drawString("You can NOT waste TURBO TANK properly right now, so its", 197, 87);
                this.rd.drawString("best to avoid him, try not to fall off!", 197, 107);
            }
            if (n == 46) {
                this.rd.drawString("This track is a 4D object projected onto the 3D world.", 197, 67);
                this.rd.drawString("TURBO TANK is back, and this time he's the boss.", 197, 87);
                this.rd.drawString("Watch the broken roads, follow the guidance arrow, and good luck!", 197, 107);
            }
            if (n == 47) {
            ...
            if (n == 56) {
                this.rd.drawString("Ten laps. One massive race. This is the final mortal-car showdown.", 197, 67);
                this.rd.drawString("Over=Kill is the most powerful mortal car in the game.", 197, 87);
                this.rd.drawString("Use everything you've unlocked and survive all ten laps.", 197, 107);
            ...
            if (n == 58) {
                ...
                this.rd.drawString("Completing this stage will not unlock the Phantom, you'll have", 197, 107);
                this.rd.drawString("to beat HELL to unlock him.", 197, 127);
            }
            if (n == 59) {
            ...
            if (n == 60) {
                this.rd.drawString("Without a doubt, this is the longest stage in the game.", 197, 67);
                this.rd.drawString("This could be an intense race if many fast vehicles appear!", 197, 107);
                this.rd.drawString("GOOD LUCK!", 197, 127);
            }
            if (n == 61) {
            ...
            if (n == 62) {
                ...
                this.rd.drawString("There are three TURBO TANKS to hunt you down,", 197, 87);
            ...
            if (n == 66) {
                this.rd.drawString("Same thing as last time, but you can't go over the course to avoid", 197, 67);
                this.rd.drawString("the Train.", 197, 87);
            ...
            if (n == 70) {
                ...
                this.rd.drawString("May God have mercy on your sou-. Wait, something is coming to help?", 197, 127);
                this.rd.drawString("WARHEAD: Player, you've earned my respect, GO! I will hold them off!", 197, 147);
