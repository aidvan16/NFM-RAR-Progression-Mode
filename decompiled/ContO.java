...
public class ContO {
    ...
    public ContO(byte[] abyte0, Medium medium, Trackers trackers, CheckPoints checkpoints, int i9, int j9, int k9) {
        this.x = i9;
        this.y = j9;
        this.z = k9;
        this.checkpoint = 0;
        ...
        try {
            ...
            while ((s = datainputstream.readLine()) != null) {
                ...
                if (s1.startsWith("</p>")) {
                    this.p[this.npl] = new Plane(this.m, this.t, this.cp, ai, ai2, ai1, i, ai3, flag2, k, l, 0, 0, 0, this.disline, 0, flag3, byte0);
                    ++this.npl;
                    flag = false;
                }
                ...
                if (s1.startsWith("w")) {
                    ...
                    ++j;
                    wheels.make(this.m, this.t, this.cp, this.p, this.npl, (int)((float)this.getvalue("w", s1, 0) * f * f1), (int)((float)this.getvalue("w", s1, 1) * f), (int)((float)this.getvalue("w", s1, 2) * f), this.getvalue("w", s1, 3), (int)((float)this.getvalue("w", s1, 4) * f * f1), (int)((float)this.getvalue("w", s1, 5) * f), i1);
                    this.npl += 15;
                }
    ...
    public ContO(ContO conto, int i, int j, int k, int l, CheckPoints checkpoints) {
        this.llx = i;
        this.lly = j;
        this.llz = k;
        this.checkpoint = 0;
        ...
        for (int i1 = 0; i1 < this.npl; ++i1) {
            ...
            this.p[i1] = new Plane(this.m, this.t, this.cp, conto.p[i1].ox, conto.p[i1].oz, conto.p[i1].oy, conto.p[i1].n, conto.p[i1].oc, conto.p[i1].glass, conto.p[i1].gr, conto.p[i1].fs, conto.p[i1].wx, conto.p[i1].wy, conto.p[i1].wz, conto.disline, conto.p[i1].bfase, conto.p[i1].road, conto.p[i1].light);
        }
        this.x = i;
        this.y = j;
        this.z = k;
    ...
    public void d(Graphics g) {
        ...
        int k9 = this.m.cx + (int)((float)(this.x - this.m.x - this.m.cx) * this.m.cos(this.m.xz) - (float)(this.z - this.m.z - this.m.cz) * this.m.sin(this.m.xz));
        int l9 = this.m.cz + (int)((float)(this.x - this.m.x - this.m.cx) * this.m.sin(this.m.xz) + (float)(this.z - this.m.z - this.m.cz) * this.m.cos(this.m.xz));
        int i19 = this.m.cz + (int)((float)(this.y - this.m.y - this.m.cy) * this.m.sin(this.m.zy) + (float)(l9 - this.m.cz) * this.m.cos(this.m.zy));
        if (this.dist != 0) {
            this.dist = 0;
        }
        ...
        if (this.xs(i + this.maxR * 2, k) > 0 && this.xs(i - this.maxR * 2, k) < this.m.w && k > -this.maxR && (k < this.m.fade[this.disline] + this.maxR || this.m.trk) && (l > this.disp || this.m.trk)) {
            ...
            if (this.ys((j1 = this.m.cy + (int)((float)(this.y - this.m.y - this.m.cy) * this.m.cos(this.m.zy) - (float)(j - this.m.cz) * this.m.sin(this.m.zy))) + this.maxR, k) > 0 && this.ys(j1 - this.maxR, k) < this.m.h) {
                ...
                for (int l3 = 0; l3 < this.npl; ++l3) {
                    this.p[ai1[l3]].d(g, this.x - this.m.x, this.y - this.m.y, this.z - this.m.z, this.xz, this.xy, this.zy, this.wxz, this.wzy, this.noline, l, this.cp);
    ...
    public void tryexp(ContO conto) {
        int i;
        if (!(conto.exp || this.out || this.exp || (i = this.getpy(conto.x, conto.y, conto.z)) >= this.maxR / 10 * (this.maxR / 10) + conto.maxR / 10 * (conto.maxR / 10) || i <= 0)) {
            if (this.pcol != 0) {
                block0: for (int j = 0; j < this.npl; ++j) {
                    for (int k = 0; k < this.p[j].n; ++k) {
                        if ((conto.x - (this.x + this.p[j].ox[k])) * (conto.x - (this.x + this.p[j].ox[k])) + (conto.y - (this.y + this.p[j].oy[k])) * (conto.y - (this.y + this.p[j].oy[k])) + (conto.z - (this.z + this.p[j].oz[k])) * (conto.z - (this.z + this.p[j].oz[k])) >= conto.maxR * 10 / this.pcol * (conto.maxR * 10 / this.pcol)) continue;
                        conto.exp = true;
                        continue block0;
                    }
                }
