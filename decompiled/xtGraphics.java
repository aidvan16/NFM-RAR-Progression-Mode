...
implements Runnable {
    ...
    int auscnt = 45;
    boolean aflk = false;
    int[] sndsize = new int[]{106, 76, 56, 116, 92, 208, 70, 80, 152, 102, 27, 65, 52, 30, 151, 129, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70, 70};
    Image hello;
    Image sign;
    Image loadbar;
    int kbload = 0;
    ...
    int trkl = 0;
    int trklim;
    float[] hipno = new float[]{1.0f, 1.0f, 3.0f, 1.0f, 1.2f, 1.0f, 1.7f, 1.0f, 1.0f, 8.0f, 1.5f, 2.0f, 1.2f, 10.0f, 1.8f, 1.4f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f};
    int flkat;
    int movly;
    int xdu = 272;
    int ydu = 2;
    ...
    public void arrow(int i, int j, CheckPoints checkpoints, boolean flag) {
        ...
        if (!flag) {
            ...
            this.drawcs(13, this.names[this.sc[l]], 100, 100, 100, 0);
        }
        k += this.m.xz;
        while (k < 0) {
            k += 360;
            ...
            if (flag && madness.mtouch) {
                if (!madness.capsized) {
                    if (!flag1) {
                        ...
                        this.sparkeng(-1);
                        if (flag2 && madness.cn != 21 && madness.cn != 24 && madness.cn != 25 && madness.cn != 28 && madness.cn != 29 && madness.cn != 30 && madness.cn != 31 && madness.cn != 33 && madness.cn != 34 && madness.cn != 36 && madness.cn != 37 && madness.cn != 38 && madness.cn != 39) {
                            if (this.stopcnt <= 0) {
                                this.air[5].loop();
                                this.stopcnt = 10;
                            }
    ...
    public void loadmusic(int i, int j) {
        ...
        if (i == 18) {
            this.stracks[17].loadMod(1100, 8150, 165, this.sunny, this.macn);
        }
        if (i == 19) {
        ...
        if (i == 21) {
            this.stracks[20].loadMod(400, 8200, 255, this.sunny, this.macn);
        }
        if (i == 22) {
        ...
        if (i == 24) {
            this.stracks[23].loadMod(300, 10000, 125, this.sunny, this.macn);
        }
        if (i == 25) {
        ...
        if (i == 36) {
            this.stracks[35].loadMod(1000, 8150, 125, this.sunny, this.macn);
        }
        if (i == 37) {
        ...
        if (i == 39) {
            this.stracks[38].loadMod(400, 7900, 125, this.sunny, this.macn);
        }
        if (i == 40) {
        ...
        if (i == 52) {
            this.stracks[51].loadMod(290, 9000, 145, this.sunny, this.macn);
        }
        if (i == 53) {
    ...
    public void loadimages() {
        ...
        try {
            ...
            while (zipentry != null) {
                ...
                if (s.equals("recharged.gif")) {
                    this.recharged = this.loadimage(abyte0, mediatracker, toolkit);
                }
                this.dnload += 3;
    ...
    public void stat(Madness madness, CheckPoints checkpoints, Control control, boolean flag) {
        ...
        if (this.fase != -2) {
            ...
            do {
                ...
                if (i == 0) {
                    ...
                    if (this.aflk) {
                        ...
                        this.drawcs(120, "" + this.names[this.sc[i]] + " finished first, race over!", 255, 255, 255, 0);
                        this.aflk = true;
                    }
                    this.winner = false;
                }
            ...
            if (flag) {
                if (checkpoints.stage != 20 && checkpoints.stage != 57 && this.arrace != control.arrace) {
                ...
                if (checkpoints.stage != 20 && checkpoints.stage != 57 && !this.holdit && this.fase != -6 && this.starcnt == 0) {
            ...
            if (!this.holdit) {
                ...
                if (madness.trcnt == 10) {
                    ...
                    if (this.auscnt < 45) {
                        ...
                        this.asay = byte0 != 3 ? this.adj[byte0][(int)(this.m.random() * 8.0f)] + this.asay + this.exlm[byte0] : this.adj[byte0][(int)(this.m.random() * 8.0f)];
                        if (!this.wasay) {
    ...
    public void finish(CheckPoints checkpoints, ContO[] aconto, Control control) {
        ...
        if (control.enter || control.handb) {
            ...
            if (checkpoints.stage == this.unlocked && this.winner && this.unlocked != 56) {
                ++checkpoints.stage;
                ++this.unlocked;
            }
            this.flipo = 0;
    ...
    public void sortcars(int i, CheckPoints checkpoints) {
        this.sc[1] = (int)(Math.random() * 40.0);
        this.sc[2] = (int)(Math.random() * 40.0);
        this.sc[3] = (int)(Math.random() * 40.0);
        this.sc[4] = (int)(Math.random() * 40.0);
        this.sc[5] = (int)(Math.random() * 40.0);
        this.sc[6] = (int)(Math.random() * 40.0);
        if (checkpoints.stage == 2) {
            this.sc[6] = 8;
        }
        if (checkpoints.stage == 3 || checkpoints.stage == 4) {
            this.sc[6] = 9;
        }
        ...
        if (checkpoints.stage == 13 || checkpoints.stage == 14) {
            this.sc[6] = 14;
        }
        ...
        if (checkpoints.stage == 37 || checkpoints.stage == 42) {
            this.sc[6] = this.sc[0];
        }
    ...
    public void stageselect(CheckPoints checkpoints, Control control) {
        ...
        this.rd.setFont(new Font("SansSerif", 1, 13));
        this.ftm = this.rd.getFontMetrics();
        if (checkpoints.stage != 36 && checkpoints.stage != 37 && checkpoints.stage != 38 && checkpoints.stage != 60) {
        ...
        if (control.right && checkpoints.stage != 60) {
            ++checkpoints.stage;
            this.fase = 2;
            control.right = false;
        }
    ...
    public xtGraphics(Medium medium, CheckPoints checkpoints, Graphics g, Applet applet) {
        this.sc = new int[7];
        ...
        this.stracks = new RadicalMod[60];
        this.loadedt = new boolean[60];
    ...
    public void loaddata(int i) {
        ...
        j = 0;
        do {
            this.train[j] = this.getSound("sounds/" + s + "train" + (j + 1) + "." + s1);
            if (i == 2) {
                this.dnload += 10;
                continue;
            }
        ...
        this.dnload = i == 2 ? (this.dnload += 24) : (this.dnload += 4);
        this.explosion = this.getSound("sounds/" + s + "explosion." + s1);
        this.dnload = i == 2 ? (this.dnload += 24) : (this.dnload += 4);
        this.firewasted = this.getSound("sounds/" + s + "firewasted." + s1);
        this.dnload = i == 2 ? (this.dnload += 24) : (this.dnload += 10);
        this.flames = this.getSound("sounds/" + s + "flames." + s1);
        this.dnload = i == 2 ? (this.dnload += 24) : (this.dnload += 10);
        this.out = this.getSound("sounds/" + s + "out." + s1);
        this.dnload = i == 2 ? (this.dnload += 24) : (this.dnload += 10);
        j = 0;
        do {
        ...
        j = 0;
        do {
            this.killomatic[j] = this.getSound("sounds/" + s + "killomatic" + (j + 1) + "." + s1);
            if (i == 2) {
                this.dnload += 22;
                continue;
            }
        ...
        j = 0;
        do {
            this.nuke[j] = this.getSound("sounds/" + s + "nuke" + (j + 1) + "." + s1);
            if (i == 2) {
                this.dnload += 22;
                continue;
            }
        ...
        j = 0;
        do {
            this.guns[j] = this.getSound("sounds/" + s + "gun" + (j + 1) + "." + s1);
            if (i == 2) {
                this.dnload += 22;
                continue;
            }
    ...
    public void carselect(Control control, ContO[] aconto, Madness madness) {
        ...
        if (this.flipo == 0) {
            ...
            if ((this.sc[0] - 7) * 0 >= this.unlocked) {
                if (this.gatey == 300) {
                    int i = 0;
                    do {
                        this.pgas[i] = false;
                ...
                if (this.flatrstart == 6) {
                    ...
                    f = this.firepower[this.sc[0]];
                    this.rd.fillRect((int)(97.0f + 156.0f * f), 357, (int)(156.0f * (1.0f - f) + 1.0f), 7);
        ...
        if (control.handb || control.enter) {
            if (this.flipo == 0 && (this.sc[0] - 7) * 0 < this.unlocked) {
                this.lastload = -11;
                this.cars.stop();
                this.cars.unloadMod();
                this.m.crs = false;
    ...
    public void loadingfailed(int i, Control control, CheckPoints checkpoints) {
        this.trackbg(false);
        this.rd.drawImage(this.br, 0, 0, null);
        this.rd.drawImage(this.select, 273, 45, null);
        this.rd.drawImage(this.back[this.pback], 50, 110, null);
    ...
    public void hipnoload(int i, boolean flag) {
        ...
        int byte0 = -90;
        if (i == 1 || i == 2 || i == 3 || i == 4 || i == 7 || i == 8 || i == 9 || i == 10 || i == 12 || i == 13 || i == 16 || i == 17 || i == 18 || i == 19 || i == 20 || i == 21 || i == 26 || i == 27 || i == 28 || i == 29 || i == 31 || i == 32 || i == 33 || i == 37 || i == 38 || i == 39 || i == 40 || i == 41 || i == 44 || i == 45 || i == 46 || i == 49 || i == 50 || i == 52 || i == 54 || i == 55 || i == 57 || i == 59 || i == 60) {
            byte0 = 0;
        }
        if (byte0 == 0) {
            int k1;
            ...
            if (i == 3) {
                ...
                this.rd.drawString("Don't upset him or you'll be arrested (destroyed)!", 197, 87);
            ...
            if (i == 12) {
                ...
                this.rd.drawString("MASHEEN is hiding out there somewhere, don't get mashed now!", 197, 87);
            }
            if (i == 13) {
            ...
            if (i == 17) {
                this.rd.drawString("(A perfect stage for KILL-O-MATIC!)", 197, 67);
            }
            if (i == 18) {
            ...
            if (i == 19) {
                this.rd.drawString("Plan A: Waste 'Em!", 197, 67);
                this.rd.drawString("Plan B: Waste 'Em!", 197, 87);
            }
            if (i == 20 || i == 52) {
                this.rd.drawString("> Note: Guidance Arrow is disabled in this stage! <", 197, 67);
            }
            if (i == 21) {
                this.rd.drawString("3...2...1...GO!...CRASH...YOU'RE WASTED!", 197, 67);
            }
            if (i == 26) {
                this.rd.drawString("NOTE: This stage contains a slight gravitational field.", 197, 67);
                this.rd.drawString("All cars are pulled towards the starting point", 197, 87);
            }
            if (i == 27) {
                this.rd.drawString("NOTE: AI's drive drunk (backwards) in this stage!", 197, 67);
                this.rd.drawString("Also, see if you can find the fix hoop", 207, 87);
            }
            if (i == 28) {
                this.rd.drawString("NOTE: It's you v.s. them!", 197, 67);
                this.rd.drawString("Do you have what it takes to waste them all?", 197, 87);
            }
            if (i == 29) {
                this.rd.drawString("The leap of faith...", 197, 67);
            }
            if (i == 31) {
                this.rd.drawString("NOTE: The Phantom cannot colide with other cars.", 197, 67);
            }
            if (i == 32) {
                this.rd.drawString("I know what you're thinking, but YES", 197, 67);
                this.rd.drawString("this stage can be won.", 197, 107);
            }
            if (i == 33) {
                this.rd.drawString("NOTE: Don't fall off!", 197, 67);
            }
            if (i == 37) {
                this.rd.drawString("Ready for some slippin' and slidin'?", 197, 67);
                this.rd.drawString("Hint: Use the track edges to get more traction.", 197, 87);
            }
            if (i == 38) {
                this.rd.drawString("There's even madness on the moon!", 197, 67);
                this.rd.drawString("The reduced gravity helps with stunts as well.", 197, 87);
            }
            if (i == 39) {
                this.rd.drawString("NOTE: There are no fix hoops in this stage!", 197, 67);
                this.rd.drawString("There is a Lightning Rod and three TURBO TANKS though!", 197, 87);
            }
            if (i == 40) {
                this.rd.drawString("NOTE: In this stage, cars get fixed when they touch the walls.", 197, 67);
                this.rd.drawString("Take the Destroyer and try to literally kick them out!", 197, 87);
            }
            if (i == 41) {
                this.rd.drawString("All bully cars are competing for kills in this stage!", 197, 67);
                this.rd.drawString("Better watch out!", 197, 87);
            }
            if (i == 44) {
                this.rd.drawString("In this stage, everyone's cookin'!", 197, 67);
                this.rd.drawString("Be fast through the checkpoints, and don't get hit by Lighning Rod.", 197, 87);
            }
            if (i == 45) {
                this.rd.drawString("The Warhead kills in one hit.", 197, 67);
                this.rd.drawString("Try to race without getting TOO close!", 197, 87);
            }
            if (i == 46) {
                this.rd.drawString("He seeks revenge...don't get blown up now!", 197, 67);
                this.rd.drawString("Hint: Take a fast car and run for your life!", 197, 87);
            }
            if (i == 49) {
                this.rd.drawString("KILL-O-MATIC is coming through", 197, 67);
                this.rd.drawString("But he's NOT racing!", 197, 87);
            }
            if (i == 50) {
                this.rd.drawString("The longest race in Revised and Recharged", 197, 67);
            }
            if (i == 54) {
                this.rd.drawString("This could very well be the fastest paced race in the game!", 197, 67);
                this.rd.drawString("Need a challange? Take the Awesome Radical One.", 197, 107);
            }
            if (i == 55) {
                this.rd.drawString("Destroy them all...", 197, 67);
                this.rd.drawString("Don't let them all destroy you", 197, 87);
                this.rd.drawString("...And mind those mimics.", 197, 107);
            }
            if (i == 57) {
                this.rd.drawString("With a little luck, you might win here!", 197, 67);
                this.rd.drawString("Keep up with the Phantom", 197, 87);
                this.rd.drawString("Avoid The Destroyer! (When possible)", 197, 107);
            }
            if (i == 59) {
                this.rd.drawString("It's a death race!", 197, 67);
                this.rd.drawString("Get past the obstacles and keep pace with the Phantom/Destroyers.", 197, 87);
                this.rd.drawString("Plus, watch out for Train of Terror/KILL-O-MATICS!", 197, 107);
            }
            if (i == 60) {
                this.rd.drawString("This is it!  The toughest stage in Revised and Recharged!", 197, 67);
                this.rd.drawString("The superpowers of the game are getting their revenge!", 197, 107);
