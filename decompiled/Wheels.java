...
public class Wheels {
    ...
    public void make(Medium medium, Trackers trackers, CheckPoints checkpoints, Plane[] aplane, int i, int j, int k, int l, int i1, int j1, int k1, int l1) {
        int[] ai = new int[16];
        int[] ai1 = new int[16];
        int[] ai2 = new int[16];
        ...
        aplane[i] = new Plane(medium, trackers, checkpoints, ai, ai2, ai1, 16, ai3, false, l1, 0, i2, k, l, 7, 0, false, 0);
        ++this.mast;
        ...
        aplane[i] = new Plane(medium, trackers, checkpoints, ai, ai2, ai1, 3, this.rc, false, j2, 0, i2, k, l, 7, 0, false, 0);
        ...
        aplane[i] = new Plane(medium, trackers, checkpoints, ai, ai2, ai1, 4, ai3, false, l1, -1 * byte0, i2, k, l, 7, 0, false, 0);
        ++i;
        ai[0] = (int)((float)j - 4.0f * f);
