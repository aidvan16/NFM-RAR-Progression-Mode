...
public class Plane {
    ...
    public Plane(Medium medium, Trackers trackers, CheckPoints checkpoints, int[] ai, int[] ai1, int[] ai2, int i, int[] ai3, boolean flag, int j, int k, int l, int i1, int j1, int k1, int l1, boolean flag1, int i2) {
        if (checkpoints.stage == 61) {
            this.embos = 1;
        }
        this.typ = 0;
        this.pa = 0;
    ...
    public void d(Graphics g, int i, int j, int k, int l, int i1, int j1, int k1, int l1, boolean flag, int i2, CheckPoints checkpoints) {
        if (this.master != 0) {
        ...
        if (flag2) {
            ...
            if (this.m.lightson && this.light == 2 && this.embos == 0) {
                i13 -= 40;
            }
            if (this.light == 3 && this.embos != 0) {
                i13 += 150;
            }
            int j14 = 0;
            int k15 = 0;
            ...
            int l18 = (i17 + j17) / 2;
            if (this.av > 7000) {
                this.av = checkpoints.stage == 22 || checkpoints.stage == 28 || checkpoints.stage == 30 || checkpoints.stage == 34 || checkpoints.stage == 40 || checkpoints.stage == 46 || checkpoints.stage == 50 || checkpoints.stage == 51 || checkpoints.stage == 54 || checkpoints.stage == 60 ? (int)Math.sqrt((this.m.cy - l17) * (this.m.cy - l17) + (this.m.cx - j18) * (this.m.cx - j18) + i13 * i13 * i13) : (int)Math.sqrt((this.m.cy - l17) * (this.m.cy - l17) + (this.m.cx - j18) * (this.m.cx - j18) + l18 * l18 + i13 * i13 * i13);
            }
            if (this.av < 7001) {
            ...
            if (!(this.m.trk || this.av <= this.m.fade[this.disline] && this.av != 0)) {
                flag2 = checkpoints.stage == 22 || checkpoints.stage == 28 || checkpoints.stage == 30 || checkpoints.stage == 34 || checkpoints.stage == 40 || checkpoints.stage == 46 || checkpoints.stage == 50 || checkpoints.stage == 51 || checkpoints.stage == 54 || checkpoints.stage == 60;
            }
        ...
        if (flag2) {
            ...
            if (this.m.lightson && this.embos == 0) {
                if (this.light == 2) {
                    l11 = 255;
                    j13 = 0;
                    k14 = 0;
            ...
            if (!flag) {
                if (this.flx == 0) {
                    if (checkpoints.stage != 43) {
                        l11 = (int)((double)l11 / 2.5);
                        j13 = (int)((double)j13 / 2.5);
                        k14 = (int)((double)k14 / 2.5);
                    } else {
                        l11 = 0;
                        j13 = 255;
                        k14 = 255;
