        ...
        if (!madness.dest) {
            if (this.stcnt > this.statusque) {
                ...
                if (this.cntrn == 0) {
                    ...
                    if (checkpoints.stage == 16 || checkpoints.stage == 17 || checkpoints.stage == 21 || checkpoints.stage == 22 || checkpoints.stage == 25 || checkpoints.stage == 26 || checkpoints.stage == 24 || checkpoints.stage == 54 || checkpoints.stage == 42 || checkpoints.stage == 36 || checkpoints.stage == 29 || checkpoints.stage == 18 || checkpoints.stage == 65 || checkpoints.stage == 14 || checkpoints.stage == 57 || checkpoints.stage == 45 || checkpoints.stage == 46 || checkpoints.stage == 8 || checkpoints.stage == 38 || checkpoints.stage == 37 || checkpoints.stage == 39 || checkpoints.stage == 62 || checkpoints.stage == 40 || checkpoints.stage == 31 || checkpoints.stage == 61 || checkpoints.stage == 34 || checkpoints.stage == 51 || checkpoints.stage == 3 || checkpoints.stage == 64 || checkpoints.stage == 53 || checkpoints.stage == 48 || checkpoints.stage == 52 || checkpoints.stage == 60 || checkpoints.stage == 68 || checkpoints.stage == 44 || checkpoints.stage == 69 || checkpoints.stage == 5) {
                        this.agressed = true;
                    }
                ...
                if (checkpoints.stage == 22 || checkpoints.stage == 24 || checkpoints.stage == 9 || checkpoints.stage == 36 || checkpoints.stage == 41 || checkpoints.stage == 45 || checkpoints.stage == 46 || checkpoints.stage == 38 || checkpoints.stage == 39 || checkpoints.stage == 62 || checkpoints.stage == 31 || checkpoints.stage == 61 || checkpoints.stage == 34 || checkpoints.stage == 51 || checkpoints.stage == 3 || checkpoints.stage == 64 || checkpoints.stage == 50 || checkpoints.stage == 53 || checkpoints.stage == 32 || checkpoints.stage == 52 || checkpoints.stage == 59 || checkpoints.stage == 60 || checkpoints.stage == 68 || checkpoints.stage == 44 || checkpoints.stage == 69 || checkpoints.stage == 5) {
                ...
                if (checkpoints.stage == 16 || checkpoints.stage == 47 || checkpoints.stage == 21 || checkpoints.stage == 22 || checkpoints.stage == 25 || checkpoints.stage == 26 || checkpoints.stage == 24 || checkpoints.stage == 54 || checkpoints.stage == 42 || checkpoints.stage == 9 || checkpoints.stage == 36 || checkpoints.stage == 29 || checkpoints.stage == 65 || checkpoints.stage == 41 || checkpoints.stage == 57 || checkpoints.stage == 45 || checkpoints.stage == 46 || checkpoints.stage == 8 || checkpoints.stage == 38 || checkpoints.stage == 37 || checkpoints.stage == 39 || checkpoints.stage == 62 || checkpoints.stage == 40 || checkpoints.stage == 55 || checkpoints.stage == 43 || checkpoints.stage == 31 || checkpoints.stage == 61 || checkpoints.stage == 34 || checkpoints.stage == 51 || checkpoints.stage == 3 || checkpoints.stage == 64 || checkpoints.stage == 50 || checkpoints.stage == 53 || checkpoints.stage == 48 || checkpoints.stage == 32 || checkpoints.stage == 52 || checkpoints.stage == 59 || checkpoints.stage == 60 || checkpoints.stage == 68 || checkpoints.stage == 44 || checkpoints.stage == 69 || checkpoints.stage == 5) {
                    this.perfection = true;
                }
                if (checkpoints.stage == 12) {
                ...
                if (this.attack == 0) {
                    ...
                    if (checkpoints.stage == 69 && madness.cn == 38) {
                        j2 = Integer.MAX_VALUE;
                        this.attack = 0;
                    }
                            ...
                            if (k8 < i9 && this.py(conto.x / 100, checkpoints.opx[i4] / 100, conto.z / 100, checkpoints.opz[i4] / 100) < l8 && this.afta && madness.power > (float)j2) {
                                ...
                                if (checkpoints.stage == 70 && madness.cn == 38) {
                                    if (i4 == 0) {
                                        ...
                                        // Aggressively attack the other CPUs.
                                        f2 = 1.0f;
                                    }
                                }
            ...
            if (flag) {
                ...
                if (this.attack == 0) {
                    ...
                    if (checkpoints.stage == 46 && madness.cn == 13 && (checkpoints.clear[0] == 4 || checkpoints.clear[0] == 13 || checkpoints.clear[0] == 21)) {
                        this.attack = 0;
                    }
                    if (checkpoints.stage == 46 && madness.cn == 26 && (checkpoints.clear[0] == 4 || checkpoints.clear[0] == 13 || checkpoints.clear[0] == 21)) {
                        this.attack = 0;
                    }
                    if (checkpoints.stage == 46 && madness.cn == 35 && (checkpoints.clear[0] == 4 || checkpoints.clear[0] == 13 || checkpoints.clear[0] == 21)) {
                        this.attack = 0;
                    }
                    if (checkpoints.stage == 46 && madness.missedcp != 0 && (checkpoints.pos[madness.im] == 0 || checkpoints.pos[madness.im] == 1 && checkpoints.pos[0] == 0)) {
                        this.attack = 0;
                    }
                    if (checkpoints.stage == 46 && checkpoints.pos[0] > checkpoints.pos[madness.im] && madness.power < 80.0f) {
                        this.attack = 0;
                    }
