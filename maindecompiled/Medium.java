...
public class Medium {
    ...
    public void follow(ContO conto, Madness madness, int i, int j) {
        int k;
        if (madness.cn != 37) {
            this.zy = 10;
            k = 2 + Math.abs(this.bcxz) / 4;
            if (k > 20) {
                k = 20;
            }
            if (j != 0) {
        ...
        if (madness.cn == 37) {
            ...
            k = conto.y + (int)((float)(conto.y + this.yart - conto.y) * this.cos(conto.zy) - (float)(conto.z + 260 - conto.z) * this.sin(conto.zy));
            int l = conto.z + (int)((float)(conto.y + this.yart - conto.y) * this.sin(conto.zy) + (float)(conto.z + 260 - conto.z) * this.cos(conto.zy));
            int i1 = conto.x + (int)((float)(-(l - conto.z)) * this.sin(conto.xz));
            int j1 = conto.z + (int)((float)(l - conto.z) * this.cos(conto.xz));
            this.zy = -i;
            this.xz = -j;
            this.x += i1 - this.cx - this.x;
            this.z += j1 - this.cz - this.z;
            this.y += k - this.cy - this.y;
            this.y -= 125;
        }
    }
